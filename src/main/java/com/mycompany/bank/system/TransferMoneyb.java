 ...
 * @author RUMMON
 */
public class TransferMoneyb extends javax.swing.JFrame {
    ...
    public TransferMoneyb(business Luser) {
        initComponents();
        this.Luser = Luser;
            ...
            if (i.comaccid.equals(id)) {
                ...
                if (currBalance > amount) {
                    ...
                    for (business u : businesses) {
                        if (u.comaccid.equals(Luser.comaccid)) {
...
//                    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TransferMoneyb.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
