...
public class PdfWithdrawr {
    ...
    public static void main(user u, cashier c, String amount) throws IOException {
        LocalDateTime dt = LocalDateTime.now();
        ...
        String DEST = System.getProperty("user.home") + File.separator +"Desktop"+File.separator+"green_bank"+File.separator+"transfer"+fdt + "_" + u.name + "_" + "to" + "_" + c.counter + ".pdf";
        new PdfWithdrawr().createPdf(DEST, u, c, amount);
    }

    public void createPdf(String dest, user u, cashier c, String amount) throws IOException {
...
//            title.add("Trust, Deposit, Fast");
            ...
            transdetail.addCell(text("Counter no.", 15f, true, true, false));
            transdetail.addCell(text("(" + c.counter + ") " + c.name, 15f, false, true, false));
            transdetail.addCell(text("Branch", 15f, true, false, false));
            transdetail.addCell(text(c.branch, 15f, false, false, false));
            ...
            baldetail.addCell(text("Withdrawn", 15f, true, false, false));
