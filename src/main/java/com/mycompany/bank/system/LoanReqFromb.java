 ...
 * @author RUMMON
 */
public class LoanReqFromb extends javax.swing.JFrame {

    /**
     * Creates new form LoanReqFrom
     */
    business Luser;
    public LoanReqFromb(business u) {
        this.Luser = u;
        initComponents();
    }
...
//        // TODO add your handling code here:
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        new LoanStatusb(Luser).setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoanReqFromb.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
