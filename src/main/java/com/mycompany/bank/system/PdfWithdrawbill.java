...
public class PdfWithdrawbill {
    ...
    public static void main(user u, business s, String amount) throws IOException {
        LocalDateTime dt = LocalDateTime.now();
        ...
        String DEST = System.getProperty("user.home") + File.separator +"Desktop"+File.separator+"green_bank"+File.separator+"Bill_"+fdt + "_" + u.accId + "_" + "to" + "_" + s.comname + ".pdf";
        new PdfWithdrawbill().createPdf(DEST, u, s, amount);
    }

    public void createPdf(String dest, user u, business s, String amount) throws IOException {
...
//            document.add(new Paragraph("\n"));
            ...
            transdetail.addCell(text("Paid to", 15f, true, true, false));
            transdetail.addCell(text(s.comname, 15f, false, true, false));
            transdetail.addCell(text("Amount", 15f, true, false, false));
            transdetail.addCell(text(amount + " TK", 15f, false, false, false));
